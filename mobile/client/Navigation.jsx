    ...
    return (
      <NavBar brandRoute="/app">
        <ul className="nav navbar-nav">
          ...
          <NavLink to="/app" index>Registrar Mascotas</NavLink>         
          <NavLink to="/mascotas">Mascotas Registradas</NavLink>
          <NavLink to="/solicitudes">Solicitudes</NavLink>
          <NavLink to="/cuenta">Cuenta</NavLink>
        </ul>
        <button className="btn btn-default navbar-right" style={{marginTop: "8px"}} onClick={this.props.signOut}>Salir</button>
      </NavBar>
    );
  }
});
      ...
      <nav className="navbar navbar-default">
        <div className="container-fluid">
          <div className="navbar-header">
            ...
            <Link className="navbar-brand" to={this.props.brandRoute}>TinDog Albergue</Link>
          </div>
